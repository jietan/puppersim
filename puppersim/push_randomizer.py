...
# There is an old version in pybullet but this version has a few fixes that
# matches the env used here.
  ...
  def __init__(
    ...
    Args:
      ...
      vertical_force_bound: The z component (abs value) bound of the applied
        perturbation force.
    """
    if perturbation_interval_steps < perturbation_duration_steps:
        raise ValueError("Interval should be always greater or equal to duration.")
